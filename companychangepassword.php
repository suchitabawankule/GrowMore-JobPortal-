...
{
	$sqlupd= "UPDATE company SET password='$_POST[password]' WHERE company_id='$_SESSION[company_id]' AND password='$_POST[opassword]'";
	$qsqlupd = mysqli_query($con,$sqlupd);
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Password updated  successfully..');</script>";
		echo "<script>window.location='companychangepassword.php';</script>";
	}
	else
	{
...
<div class="mb-4 mb-md-1 mr-12">
	<div class="job-post-item-header d-flex align-items-center">
	  <h2 class="mr-3 text-black h3">Company - Change Password</h2>
	</div>
